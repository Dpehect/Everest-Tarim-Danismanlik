...
import 'package:getagriculture/pages/profilesection/AnalizePageProfile.dart';
import 'package:getagriculture/pages/profilesection/report_page_profile.dart';
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ReportPageProfile(),
                      ),
                    );
                  },
                  child: Text(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          // Add the navigation logic for the text on the right of the icon
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => ReportPageProfile(),
